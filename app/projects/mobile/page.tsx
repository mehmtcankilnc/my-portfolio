...
const ImageCarousel = ({
  ...
  return (
    <div className="relative w-64 md:w-72 aspect-9/20 bg-black border-4 border-black overflow-hidden flex items-center justify-center shadow-[6px_6px_0px_black] shrink-0">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1/3 h-5 bg-black z-20 border-b-4 border-x-4 border-black"></div>
      {images.map((img, idx) => (
        <Image
          key={idx}
          src={img}
          ...
          {mobileProjects.map((project, index) => (
            ...
            >
              <div className="relative group">
                ...
                <div className="absolute -top-4 -left-4 w-12 h-12 border-t-4 border-l-4 border-industrial-yellow -z-10 transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2"></div>
                <div className="absolute -bottom-4 -right-4 w-12 h-12 border-b-4 border-r-4 border-industrial-yellow -z-10 transition-transform group-hover:translate-x-2 group-hover:translate-y-2"></div>
              </div>
              <div className="flex-1 flex flex-col bg-white border-4 border-black p-6 md:p-10 shadow-[8px_8px_0px_black] relative">
